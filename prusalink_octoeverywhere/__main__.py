...
from .prusalinkhost import PrusaLinkHost
...
if __name__ == '__main__':
    ...
    try:
        host = PrusaLinkHost(ConfigFolder, LogFolder, devConfig_CanBeNone) #pyright: ignore[reportArgumentType,reportPossiblyUnboundVariable]
        ...
        s.PrintErrorAndExit(f"Exception leaked from main Prusa Link host class. Error:{str(e)}")
