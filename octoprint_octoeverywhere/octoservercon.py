...
class OctoServerCon:
    ...
    def OnOpened(self, ws):
        ...
        self.OctoSession = OctoSession(self, self.Logger, self.PrinterId, self.IsPrimaryConnection, self.ActiveSessionId, self.OctoPrintLocalPort, self.MjpgStreamerLocalPort, self.UiPopupInvoker, self.PluginVersion)
