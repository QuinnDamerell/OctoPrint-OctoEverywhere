...
class Startup:
    ...
    def GetDevConfigIfAvailable(self, argv:List[str]) -> Optional[dict]:
        try:
            if len(argv) > 2:
    ...
    def GetConfigVarAndValidate(self, jsonConfig:dict, varName:str, dataType:ConfigDataTypes, oldVarName:Optional[str]=None) -> Union[bool, str]:
        var = None
