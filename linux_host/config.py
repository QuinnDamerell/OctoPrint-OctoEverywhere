...
class Config:
    ...
    # MQTT relay port. Any MQTT client on the LAN can connect to this port to receive printer messages.
    # Set to "0" to disable.
    BambuMqttRelayPort = "mqtt_relay_port"
    BambuMqttRelayPortDefault = "1883"
    ...
    c_ConfigComments = [
        ...
        { "Target": BambuMqttRelayPort,"Comment": "The port for the local MQTT relay broker. Any MQTT client on the LAN (Bambu Studio, Home Assistant, etc.) can connect to this port to receive printer messages muxed through the single connection. Set to 0 to disable."},
